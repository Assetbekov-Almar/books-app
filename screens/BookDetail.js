    ...
    function renderBookDescription() {
        ...
        return (
            <View style={{ flex: 1, flexDirection: 'row', padding: SIZES.padding }}>
                ...
                >
                    <Text style={{ color: COLORS.white, marginBottom: SIZES.padding, fontSize: 20, letterSpacing: 1.5 }}>Description</Text>
    ...
    function renderBottomButton() {
        return (
            <View style={{ flex: 1, flexDirection: 'row' }}>
                ...
                >
                    <Text style={{ color: "green", fontSize: 25 }}>Start Reading</Text>
                </TouchableOpacity>
            </View>
        )
    }
